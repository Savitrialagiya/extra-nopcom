...
public class ComputerTest1 extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        computerPage1.sendTextToEmailField("seleniumm123@gmail.com");
        computerPage1.sendTextToCompanyField("Primetest");
        computerPage1.selectCountryFromDropDownList();
        computerPage1.sendTextToCityField("London");
        computerPage1.sendTextToAddressLine1("lathi");
        computerPage1.sendTextToAddressLine2("Adtala");
        computerPage1.sendTextToPostcode("HA3 9UY");
        computerPage1.sendTextToPhoneNumberField("07757865425");
        ...
        computerPage1.sendTextToCardCode("235");
